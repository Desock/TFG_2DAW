...
export function FeaturedCircuits({ data } : { readonly data: { title: string, description: string, Label: string, 
    urlBundle: string, trackImage: {url: string, alternativeText: string}}}) {
    if (!data) return null;
    ...
    return (
        <header className={styles.header}>
            <img
                src={imageURL} 
                alt={data.trackImage.alternativeText}
